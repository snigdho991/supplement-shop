                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="{{ route('save.basic.info') }}" method="post" enctype="multipart/form-data" novalidate="">
                            @csrf
                                ...
                                <div class="row mb-4">
                                    <label for="validationTooltip03" class="col-lg-2 col-form-label">Change Profile Photo</label>
                                    
                                    <div class="col-lg-10" style="margin-bottom: 0.7rem!important;">
                                        <input type="file" class="form-control" id="validationTooltip03" name="profile_photo_path">
